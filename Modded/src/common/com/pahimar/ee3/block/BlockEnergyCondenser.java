 ...
 * 
 * BlockEnergyCondenser
 * 
 * @author pahimar & RedmenNL
 * @license Lesser GNU Public License v3 (http://www.gnu.org/licenses/lgpl.html)
 * 
 */
public class BlockEnergyCondenser extends BlockEE {
    ...
    public BlockEnergyCondenser(int id) {
        ...
        this.setUnlocalizedName(Strings.ENERGY_CONDENSER_NAME);
    ...
    public String getUnlocalizedName() {
        ...
        unlocalizedName.append(Strings.ENERGY_CONDENSER_NAME);
        ...
        if (player.isSneaking())
            ...
            if (!world.isRemote) {
                ...
                if (tileEnergyCondenser != null) {
                    player.openGui(EquivalentExchange3.instance, GuiIds.ENERGY_CONDENSER, world, x, y, z);
                }
            }
