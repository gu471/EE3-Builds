...
public class ModBlocks {
    ...
    public static void init() {
        ...
        /* RedmenNL */
        GameRegistry.registerBlock(energyCondenser, Strings.ENERGY_CONDENSER_NAME);
    ...
    private static void initBlockRecipes() {
        ...
        /*RedmenNL*/
        GameRegistry.addRecipe(new ItemStack(energyCondenser), new Object[] { "odo", "dcd", "odo", Character.valueOf('o'), Block.obsidian, Character.valueOf('d'), Item.diamond, Character.valueOf('c'), Block.chest});
    }
}
