...
public class BlockConfiguration {
    ...
    protected static void init(File configFile) {
        ...
        try {
            ...
            /* RedmenNL block configs */
            BlockIds.ENERGY_CONDENSER = blockConfiguration.getBlock(Strings.ENERGY_CONDENSER_NAME, BlockIds.ENERGY_CONDENSER_DEFAULT).getInt(BlockIds.ENERGY_CONDENSER_DEFAULT);
        }
        catch (Exception e) {
