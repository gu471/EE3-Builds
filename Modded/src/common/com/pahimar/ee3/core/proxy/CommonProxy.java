...
import com.pahimar.ee3.client.gui.inventory.GuiEnergyCondenser;
...
public class CommonProxy implements IGuiHandler {
    ...
    public void registerTileEntities() {
        ...
        /* RedmenNL */
        GameRegistry.registerTileEntity(TileEnergyCondenser.class, Strings.TE_ENERGY_CONDENSER_NAME);
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        /* RedmenNL */
            ...
            TileEnergyCondenser tileEnergyCondenser = (TileEnergyCondenser) world.getBlockTileEntity(x, y, z);
            return new ContainerEnergyCondenser(player.inventory, tileEnergyCondenser);
        }
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        /* RedmenNL */
            ...
            TileEnergyCondenser tileEnergyCondenser = (TileEnergyCondenser) world.getBlockTileEntity(x, y, z);
            return new GuiEnergyCondenser(player.inventory, tileEnergyCondenser);
        }
