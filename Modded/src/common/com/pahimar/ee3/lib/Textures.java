...
public class Textures {
    ...
    // RedmenNL GUI textures
    public static final ResourceLocation GUI_ENERGY_CONDENSER = ResourceLocationHelper.getResourceLocation(GUI_SHEET_LOCATION + "energyCondenser.png");
    ...
    // RedmenNL model textures
    public static final ResourceLocation MODEL_ENERGY_CONDENSER = ResourceLocationHelper.getResourceLocation(MODEL_SHEET_LOCATION + "energyCondenser.png");
